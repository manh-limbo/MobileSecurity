...
for algo in algorithms:
    ...
    print("False negative rate ALL: %f %%" % ((mt[0][1] / float(sum(mt[0]))) * 100))
    print('False positive rate ALL: %f %%' % ((mt[1][0] / float(sum(mt[1])) * 100)))
    ...
    mt = confusion_matrix(y_test, res)
    print("False negative rate 12: %f %%" % ((mt[0][1] / float(sum(mt[0]))) * 100))
    print('False positive rate 12: %f %%' % ((mt[1][0] / float(sum(mt[1])) * 100)))
    ...
    mt = confusion_matrix(y_test, res)
    print("False negative rate 1: %f %%" % ((mt[0][1] / float(sum(mt[0]))) * 100))
    print('False positive rate 1: %f %%' % ((mt[1][0] / float(sum(mt[1])) * 100)))
    ...
    mt = confusion_matrix(y_test, res)
    print("False negative rate 2: %f %%" % ((mt[0][1] / float(sum(mt[0]))) * 100))
    print('False positive rate 2: %f %%' % ((mt[1][0] / float(sum(mt[1])) * 100)))
